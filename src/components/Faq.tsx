...
const faqs = [
  ...
  {
    q: "Хүүхэд маань бэлэн үү?",
    a: "Түвшин тогтоох үнэлгээ өгснөөр хүүхдэд тохирох 1-10 хүртэлх түвшин, багшийн хувийн зөвлөмж, тохирох сургалтын саналыг авна. Бэлтгэлгүй сурагч ч эхлэх боломжтой.",
  },
  {
    q: "Багшид шууд асуулт асууж болох уу?",
    a: "VIP группд элссэн сурагчид багшаас шууд асуулт асуух, бодлогын тайлбар авах, эргэх холбоо тогтоох боломжтой.",
  },
  {
