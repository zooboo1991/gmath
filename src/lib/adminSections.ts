...
export type AdminSection =
  ...
  | "placement"
  /** Бодлого хувилах системээс ирсэн бодлогууд: харах, банкандаа татах.
   *  Багшийн эрхэд ОРОХГҮЙ — татах нь шалгалтын банк руу бичих үйлдэл,
   *  тэр банк өөрөө эзний мэдэлд байдаг. */
  | "bodlogo"
