...
import { getAssessmentFee, getAssessmentSla, getQuizFee } from "@/lib/assessment/db";
...
export default async function AdminAssessmentPage() {
  ...
  return (
    <div className="px-6 lg:px-10 py-8">
      ...
      <AssessmentPanel initialFee={assessmentFee} initialQuizFee={quizFee} initialSla={sla} />
    </div>
  );
}
